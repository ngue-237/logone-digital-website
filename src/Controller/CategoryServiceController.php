...
class CategoryServiceController extends AbstractController
{
    ...
    public function allCategoriesService(
        ...
        $description = "Nous sommes une agence de marketing et de communication experte dans les principaux 
                        canaux de communication digitale et de la gestion de la relation client De la création de votre site internet en 
                        passant par la mise en passant d’une stratégie digitale pour augmenter votre visibilité, 
                        ventes et notoriété sur le web, nous vous accompagnons dans le développement de votre business. ";
        $seoPage
